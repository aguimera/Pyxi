...
import Pyxi.DemodModule as Demod
...
class MainWindow(Qt.QWidget):
    ...
    def on_pars_changed(self, param, changes):
        ...
        if childName == 'Scope.FetchConfig.Demod':
            self.DemodEn = data
    ...
    def on_NewSample(self):
        ...
        if self.DemodEn == True:
            SigDem = np.zeros((self.threadGen.OutData.shape//10))
...
#        self.threadPSDPlotter.AddData(self.threadGen.OutData)
        self.threadPSDPlotter.AddData(SigDem)
